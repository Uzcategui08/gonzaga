...
return new class extends Migration
{
  public function up(): void
  {
    ...
    DB::statement("ALTER TABLE users ADD CONSTRAINT users_tipo_check CHECK (tipo IN ('admin', 'profesor', 'coordinador', 'secretaria', 'pedagogia', 'extracurricular', 'profesor_extracurricular'));");
  }
